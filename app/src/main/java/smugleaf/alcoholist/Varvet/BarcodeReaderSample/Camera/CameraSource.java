...
public class CameraSource {
    ...
    public static class Builder {
        ...
        /**
         * Creates a camera source builder with the supplied context and detector.  smugleaf.alcoholist.Varvet.BarcodeReaderSample.Camera preview
    ...
    private Camera createCamera() {
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                Log.i(TAG, "smugleaf.alcoholist.Varvet.BarcodeReaderSample.Camera focus mode: " + mFocusMode + " is not supported on this device.");
            }
        }
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes().contains(
                ...
                Log.i(TAG, "smugleaf.alcoholist.Varvet.BarcodeReaderSample.Camera flash mode: " + mFlashMode + " is not supported on this device.");
            }
        }
